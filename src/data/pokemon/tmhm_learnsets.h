...
} gTMHMLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_MAGMAR] = { .learnset = {
        ...
        .VE_TUTOR_MOVES = TRUE,
        .D: = TRUE,
        .FIRERED/LEAFGREEN:_BODY_SLAM,_COUNTER,_MEGA_KICK,_MEGA_PUNCH,_MIMIC,_SEISMIC_TOSS,_SUBSTITUTE = TRUE,
        .EMERALD:_COUNTER,_DYNAMICPUNCH,_ENDURE,_FIRE_PUNCH,_MEGA_KICK,_MEGA_PUNCH,_MIMIC,_SEISMIC_TOSS,_SLEEP_TALK,_SNORE,_SUBSTITUTE,_SWAGGER = TRUE,
        .W: = TRUE,
        .FIRERED/LEAFGREEN:_BODY_SLAM,_COUNTER,_MEGA_KICK,_MEGA_PUNCH,_MIMIC,_SEISMIC_TOSS,_SUBSTITUTE = TRUE,
        .EMERALD:_COUNTER,_DYNAMICPUNCH,_ENDURE,_FIRE_PUNCH,_THUNDERPUNCH,_MEGA_KICK,_MEGA_PUNCH,_MIMIC,_SEISMIC_TOSS,_SLEEP_TALK,_SNORE,_SUBSTITUTE,_SWAGGER = TRUE,
        .STRENGTH = TRUE,
        .ROCK_SMASH = TRUE,
    } },
