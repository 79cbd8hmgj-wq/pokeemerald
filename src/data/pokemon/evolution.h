const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PIKACHU]    = {{EVO_LEVEL, 32, SPECIES_RAICHU}},
    ...
    [SPECIES_CLEFAIRY]   = {{EVO_LEVEL, 36, SPECIES_CLEFABLE}},
    [SPECIES_VULPIX]     = {{EVO_LEVEL, 36, SPECIES_NINETALES}},
    [SPECIES_JIGGLYPUFF] = {{EVO_LEVEL, 36, SPECIES_WIGGLYTUFF}},
    ...
    [SPECIES_GLOOM]      = {{EVO_LEVEL, 36, SPECIES_VILEPLUME},
    ...
    [SPECIES_POLIWHIRL]  = {{EVO_LEVEL, 37, SPECIES_POLIWRATH},
    ...
    [SPECIES_EXEGGCUTE]  = {{EVO_LEVEL, 36, SPECIES_EXEGGUTOR}},
    ...
    [SPECIES_PORYGON]    = {{EVO_LEVEL, 38, SPECIES_PORYGON2}},
    ...
    [SPECIES_SKITTY]     = {{EVO_LEVEL, 32, SPECIES_DELCATTY}},
    ...
    [SPECIES_CLAMPERL]   = {{EVO_LEVEL, 35, SPECIES_HUNTAIL},
