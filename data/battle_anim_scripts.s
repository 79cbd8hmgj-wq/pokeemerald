...
gBattleAnims_Moves::
	...
	.4byte Move_TACKLE @ MOVE_ATTACK_ORDER
	.4byte Move_TACKLE @ MOVE_BUG_BITE
	.4byte Move_TACKLE @ MOVE_BUG_BUZZ
	.4byte Move_TACKLE @ MOVE_DEFEND_ORDER
	.4byte Move_TACKLE @ MOVE_HEAL_ORDER
	.4byte Move_TACKLE @ MOVE_U_TURN
	.4byte Move_TACKLE @ MOVE_X_SCISSOR
	.4byte Move_TACKLE @ MOVE_DRACO_METEOR
	.4byte Move_TACKLE @ MOVE_DRAGON_PULSE
	.4byte Move_TACKLE @ MOVE_DRAGON_RUSH
	.4byte Move_TACKLE @ MOVE_ROAR_OF_TIME
	.4byte Move_TACKLE @ MOVE_SPACIAL_REND
	.4byte Move_TACKLE @ MOVE_CHARGE_BEAM
	.4byte Move_TACKLE @ MOVE_DISCHARGE
	.4byte Move_TACKLE @ MOVE_MAGNET_RISE
	.4byte Move_TACKLE @ MOVE_THUNDER_FANG
	.4byte Move_TACKLE @ MOVE_AIR_SLASH
	.4byte Move_TACKLE @ MOVE_BRAVE_BIRD
	.4byte Move_TACKLE @ MOVE_CHATTER
	.4byte Move_TACKLE @ MOVE_DEFOG
	.4byte Move_TACKLE @ MOVE_PLUCK
	.4byte Move_TACKLE @ MOVE_ROOST
	.4byte Move_TACKLE @ MOVE_TAILWIND
	.4byte Move_TACKLE @ MOVE_OMINOUS_WIND
	.4byte Move_TACKLE @ MOVE_SHADOW_CLAW
	.4byte Move_TACKLE @ MOVE_SHADOW_FORCE
	.4byte Move_TACKLE @ MOVE_SHADOW_SNEAK
	.4byte Move_TACKLE @ MOVE_EARTH_POWER
	.4byte Move_TACKLE @ MOVE_MUD_BOMB
	.4byte Move_TACKLE @ MOVE_AVALANCHE
	.4byte Move_TACKLE @ MOVE_ICE_FANG
	.4byte Move_TACKLE @ MOVE_ICE_SHARD
	.4byte Move_TACKLE @ MOVE_CROSS_POISON
	.4byte Move_TACKLE @ MOVE_GASTRO_ACID
	.4byte Move_TACKLE @ MOVE_GUNK_SHOT
	.4byte Move_TACKLE @ MOVE_POISON_JAB
	.4byte Move_TACKLE @ MOVE_TOXIC_SPIKES
	.4byte Move_TACKLE @ MOVE_HEAD_SMASH
	.4byte Move_TACKLE @ MOVE_POWER_GEM
	.4byte Move_TACKLE @ MOVE_ROCK_POLISH
	.4byte Move_TACKLE @ MOVE_ROCK_WRECKER
	.4byte Move_TACKLE @ MOVE_STEALTH_ROCK
	.4byte Move_TACKLE @ MOVE_STONE_EDGE
	.4byte Move_TACKLE @ MOVE_BULLET_PUNCH
	.4byte Move_TACKLE @ MOVE_FLASH_CANNON
	.4byte Move_TACKLE @ MOVE_GYRO_BALL
	.4byte Move_TACKLE @ MOVE_IRON_HEAD
	.4byte Move_TACKLE @ MOVE_MAGNET_BOMB
	.4byte Move_TACKLE @ MOVE_METAL_BURST
	.4byte Move_TACKLE @ MOVE_MIRROR_SHOT
	.4byte Move_TACKLE @ MOVE_QUIVER_DANCE
	.4byte Move_TACKLE @ MOVE_RAGE_POWDER
	.4byte Move_TACKLE @ MOVE_STEAMROLLER
	.4byte Move_TACKLE @ MOVE_STRUGGLE_BUG
	.4byte Move_TACKLE @ MOVE_DRAGON_TAIL
	.4byte Move_TACKLE @ MOVE_DUAL_CHOP
	.4byte Move_TACKLE @ MOVE_BOLT_STRIKE
	.4byte Move_TACKLE @ MOVE_ELECTRO_BALL
	.4byte Move_TACKLE @ MOVE_ELECTROWEB
	.4byte Move_TACKLE @ MOVE_FUSION_BOLT
	.4byte Move_TACKLE @ MOVE_VOLT_SWITCH
	.4byte Move_TACKLE @ MOVE_WILD_CHARGE
	.4byte Move_TACKLE @ MOVE_ACROBATICS
	.4byte Move_TACKLE @ MOVE_HURRICANE
	.4byte Move_TACKLE @ MOVE_SKY_DROP
	.4byte Move_TACKLE @ MOVE_HEX
	.4byte Move_TACKLE @ MOVE_BULLDOZE
	.4byte Move_TACKLE @ MOVE_DRILL_RUN
	.4byte Move_TACKLE @ MOVE_FREEZE_SHOCK
	.4byte Move_TACKLE @ MOVE_FROST_BREATH
	.4byte Move_TACKLE @ MOVE_GLACIATE
	.4byte Move_TACKLE @ MOVE_ICE_BURN
	.4byte Move_TACKLE @ MOVE_ICICLE_CRASH
	.4byte Move_TACKLE @ MOVE_ACID_SPRAY
	.4byte Move_TACKLE @ MOVE_CLEAR_SMOG
	.4byte Move_TACKLE @ MOVE_COIL
	.4byte Move_TACKLE @ MOVE_SLUDGE_WAVE
	.4byte Move_TACKLE @ MOVE_VENOSHOCK
	.4byte Move_TACKLE @ MOVE_SMACK_DOWN
	.4byte Move_TACKLE @ MOVE_WIDE_GUARD
	.4byte Move_TACKLE @ MOVE_AUTOTOMIZE
	.4byte Move_TACKLE @ MOVE_GEAR_GRIND
	.4byte Move_TACKLE @ MOVE_HEAVY_SLAM
	.4byte Move_TACKLE @ MOVE_SHIFT_GEAR
	.4byte Move_COUNT @ cannot be reached, because last move is Shift Gear
